 ...
 */
public class ArrayC3TypeToEsProperty implements SpecificC3TypeConverter<Property, ArrayC3Type> {

    private static final Set<Class<? extends C3Type>> supports = Set.of(ArrayC3Type.class);

    @Override
    public Property convert(ArrayC3Type arrayC3Type, C3ConversionContext<Property> conversionContext) {
