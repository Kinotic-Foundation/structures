package org.kinotic.structures.internal.idl.converters.openapi.decorators;
...
/**
 * The {@link OpenApiDecoratorMappingProcessor} is used to create an OpenApi mapping based on data available in the {@link C3Decorator}
 * Created by Navíd Mitchell 🤪 on 5/15/23.
 */
public interface OpenApiDecoratorMappingProcessor<D extends C3Decorator> extends DecoratorMappingProcessor<D, Schema<?>, OpenApiConversionState> {
     ...
     * @param context the {@link MappingContext} for use by this {@link OpenApiDecoratorMappingProcessor}
