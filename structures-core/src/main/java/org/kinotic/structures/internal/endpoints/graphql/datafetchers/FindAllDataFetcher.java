 ...
 */
public class FindAllDataFetcher implements DataFetcher<CompletableFuture<Page<Object>>> {
    ...
    @Override
    public CompletableFuture<Page<Object>> get(DataFetchingEnvironment environment) throws Exception {
