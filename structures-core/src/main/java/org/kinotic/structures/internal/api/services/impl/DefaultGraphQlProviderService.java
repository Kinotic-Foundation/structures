...
public class DefaultGraphQlProviderService implements GraphQlProviderService {
    ...
    private static class ExecutionGraphQlServiceCacheLoader implements AsyncCacheLoader<String, GraphQL> {
                        ...
                        for (Map.Entry<String, GraphQLTypeHolder> entry : structureTypeMap.entrySet()) {
                            ...
                            queryBuilder.field(newFieldDefinition()
                                                       ...
                                                       .argument(newArgument().name("pageable")
                                                                              .type(GraphQLNonNull.nonNull(pageableReference)))
        ...
        private GraphQLInputObjectType createSortType(){
            ...
            inputBuilder.field(newInputObjectField()
                                       .name("orders")
                                       .type(GraphQLNonNull.nonNull(GraphQLList.list(GraphQLNonNull.nonNull(createOrderType())))));
            return inputBuilder.build();
        }
        ...
        private GraphQLNamedOutputType wrapForItemListResponse(GraphQLNamedOutputType graphQlOutputStructureItem) {
            return newObject()
                    ...
                    .field(newFieldDefinition()
                                   .name("content")
                                   .type(GraphQLNonNull.nonNull(GraphQLList.list(GraphQLNonNull.nonNull(graphQlOutputStructureItem)))))
                    .build();
        }
    }
}
