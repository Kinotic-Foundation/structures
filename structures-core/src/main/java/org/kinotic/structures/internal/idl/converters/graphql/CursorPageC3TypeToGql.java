 ...
 */
public class CursorPageC3TypeToGql implements C3TypeConverter<GqlTypeHolder, CursorPageC3Type, GqlConversionState> {
    @Override
    public boolean supports(C3Type c3Type) {
        return c3Type instanceof CursorPageC3Type;
    }
