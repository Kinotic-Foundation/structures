...
/**
 * {@link ElasticMappingPreProcessor} is used to create or modify an ElasticSearch mapping based on data available in the {@link C3Decorator}
 * Created by Navíd Mitchell 🤪 on 5/12/23.
 */
public interface ElasticMappingPreProcessor<D extends C3Decorator> extends DecoratorProcessor<D, Property, MappingContext<Property>> {
