...
/**
 * The {@link OpenApiMappingPreProcessor} is used to create or modify an OpenApi mapping based on data available in the {@link C3Decorator}
 * Created by Navíd Mitchell 🤪 on 5/15/23.
 */
public interface OpenApiMappingPreProcessor<D extends C3Decorator> extends DecoratorProcessor<D, Schema<?>, MappingContext<Schema<?>>> {
     ...
     * @param value the {@link MappingContext} for use by this {@link OpenApiMappingPreProcessor}
