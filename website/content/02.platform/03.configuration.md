...
| Property | Default | Meaning |
|---|---|---|
| `disableProvisioner` | `false` | When true nothing is uploaded or served; every published UI is marked ready at once, so publishing works in development and tests without Azure |
