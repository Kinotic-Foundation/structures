// import { markRaw, shallowReactive, computed, type ComputedRef, reactive } from 'vue'
...
//     this.projectsCount = result.totalElements
...
//     const result = await service.findAllForApplication(applicationId, pageable)
//     this.structuresCount = result.totalElements
...
//   console.log('[State] fetched app:', app)
//   this.currentApplication = app
// }
