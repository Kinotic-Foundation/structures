    ...
    <crud-entity-add-edit :crud-service-identifier="crudServiceIdentifier"
        ...
        <template #basic-info="{ entity }">
            ...
            <v-tabs fixed-tabs style="width: 100%;">
                <v-tab key="standard" v-if="!complexType" @change="updateStructure(entity)">
                    Standard
                </v-tab>
                ...
                <v-tab-item key="advanced">
                    ...
                    <div class="editor-width editor-height mt-16">
                        <v-text-field v-model='entityDefinition' :rules="[ validateEntityDefinition ]"
                                      v-show="false"></v-text-field>
                        <prism-editor class="my-editor" v-model="entityDefinition" :highlight="highlighter"
...
export default class StructureAddEdit extends Vue {
    ...
    private updateStructure(structure: any) {
