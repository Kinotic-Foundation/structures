...
<!--                                            </v-list-item-content>-->
<!--                                        </v-list-item>-->
<!--&lt;!&ndash;                                      FIXME: Need to Support Uploading of image/logo&ndash;&gt;-->
<!--&lt;!&ndash;                                        <v-list-item>&ndash;&gt;-->
<!--&lt;!&ndash;                                            <v-list-item-content>&ndash;&gt;-->
<!--&lt;!&ndash;                                                <v-text-field @change="structureChanged = true" v-model="pathToIcon" label="Path To Icon"></v-text-field>&ndash;&gt;-->
<!--&lt;!&ndash;                                            </v-list-item-content>&ndash;&gt;-->
<!--&lt;!&ndash;                                        </v-list-item>&ndash;&gt;-->
<!--                                    </v-list>-->
<!--                                    <v-divider></v-divider>-->
...
<!--import {IStructureManager} from "@/frontends/structures-admin/services"-->
