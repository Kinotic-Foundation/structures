...
import {Structures, MultiTenancyType, EntityDecorator, Structure, AutoGeneratedIdDecorator} from '../src/index.js'
...
export function createPersonSchema(suffix: string): ObjectC3Type {
    ...
    ret.name = 'Person' + suffix
    ret.namespace = 'org.kinotic.sample'
    ret.type = 'object'
    ...
    address.namespace = 'org.kinotic.sample'
    address.type = 'object'
