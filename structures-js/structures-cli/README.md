...
running command...
$ structures (--version)
@kinotic/structures-cli/1.2.0 darwin-x64 node-v20.11.0
...
_See code: [dist/commands/init.ts](https://github.com/Kinotic-Foundation/structures/blob/v1.2.0/dist/commands/init.ts)_
...
_See code: [dist/commands/synchronize.ts](https://github.com/Kinotic-Foundation/structures/blob/v1.2.0/dist/commands/synchronize.ts)_
