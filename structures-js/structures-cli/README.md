...
running command...
$ structures (--version)
@kinotic/structures-cli/1.0.4 darwin-x64 node-v18.15.0
...
_See code: [dist/commands/init.ts](https://github.com/Kinotic-Foundation/structures/blob/v1.0.4/dist/commands/init.ts)_
...
_See code: [dist/commands/synchronize.ts](https://github.com/Kinotic-Foundation/structures/blob/v1.0.4/dist/commands/synchronize.ts)_
