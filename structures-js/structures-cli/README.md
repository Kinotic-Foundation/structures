...
running command...
$ structures (--version)
@kinotic/structures-cli/3.4.0-beta.0 darwin-arm64 node-v22.13.1
...
_See code: [src/commands/generate.ts](https://github.com/Kinotic-Foundation/structures/blob/v3.4.0-beta.0/src/commands/generate.ts)_
...
_See code: [src/commands/initialize.ts](https://github.com/Kinotic-Foundation/structures/blob/v3.4.0-beta.0/src/commands/initialize.ts)_
...
_See code: [src/commands/synchronize.ts](https://github.com/Kinotic-Foundation/structures/blob/v3.4.0-beta.0/src/commands/synchronize.ts)_
