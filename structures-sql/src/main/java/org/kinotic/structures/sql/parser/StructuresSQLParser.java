...
public class StructuresSQLParser extends Parser {
	...
	public static final int
		...
		CONFLICTS=16, ABORT=17, PROCEED=18, MAX_DOCS=19, SLICES=20, AUTO=21, SIZE=22, 
		SOURCE_FIELDS=23, QUERY=24, SCRIPT=25, NUMBER_OF_SHARDS=26, NUMBER_OF_REPLICAS=27, 
		UPDATE=28, DELETE=29, FROM=30, SET=31, WHERE=32, AND=33, OR=34, TEXT=35, 
		KEYWORD=36, INTEGER=37, BOOLEAN=38, DATE=39, LPAREN=40, RPAREN=41, COMMA=42, 
		SEMICOLON=43, EQUALS=44, NOT_EQUALS=45, LESS_THAN=46, GREATER_THAN=47, 
		LESS_THAN_EQUALS=48, GREATER_THAN_EQUALS=49, PLUS=50, MINUS=51, MULTIPLY=52, 
		DIVIDE=53, PARAMETER=54, STRING=55, ID=56, INTEGER_LITERAL=57, BOOLEAN_LITERAL=58, 
		COMMENT=59, WS=60;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'REINDEX'", "'INTO'", "'WITH'", "'CONFLICTS'", "'ABORT'", "'PROCEED'", 
			"'MAX_DOCS'", "'SLICES'", "'AUTO'", "'SIZE'", "'SOURCE_FIELDS'", "'QUERY'", 
			"'SCRIPT'", "'NUMBER_OF_SHARDS'", "'NUMBER_OF_REPLICAS'", "'UPDATE'", 
			"'DELETE'", "'FROM'", "'SET'", "'WHERE'", "'AND'", "'OR'", "'TEXT'", 
			"'KEYWORD'", "'INTEGER'", "'BOOLEAN'", "'DATE'", "'('", "')'", "','", 
			"';'", "'=='", "'!='", "'<'", "'>'", "'<='", "'>='", "'+'", "'-'", "'*'", 
			"'/'", "'?'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"WITH", "CONFLICTS", "ABORT", "PROCEED", "MAX_DOCS", "SLICES", "AUTO", 
			"SIZE", "SOURCE_FIELDS", "QUERY", "SCRIPT", "NUMBER_OF_SHARDS", "NUMBER_OF_REPLICAS", 
	...
	public final MigrationsContext migrations() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 576460753108739138L) != 0)) {
				{
				{
				setState(52);
				statement();
	...
	public final OperatorContext operator() throws RecognitionException {
		...
		try {
			...
			setState(260);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 16906090788683776L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
