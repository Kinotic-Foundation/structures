...
public class StructuresSQLParser extends Parser {
	...
	public static final int
		...
		WAIT=43, TRUE=44, FALSE=45, SKIP_IF_NO_SOURCE=46, BOOLEAN=47, INTEGER=48, 
		KEYWORD=49, TEXT=50, JSON=51, BINARY=52, GEO_POINT=53, GEO_SHAPE=54, UUID=55, 
		DECIMAL=56, COMMA=57, DIVIDE=58, EQUALS=59, GREATER_THAN=60, GREATER_THAN_EQUALS=61, 
		LESS_THAN=62, LESS_THAN_EQUALS=63, LPAREN=64, MINUS=65, MULTIPLY=66, NOT_EQUALS=67, 
		PARAMETER=68, PLUS=69, RPAREN=70, SEMICOLON=71, BOOLEAN_LITERAL=72, ID=73, 
		INTEGER_LITERAL=74, STRING=75, COMMENT=76, WS=77;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'TEXT'", "'JSON'", "'BINARY'", "'GEO_POINT'", "'GEO_SHAPE'", "'UUID'", 
			"'DECIMAL'", "','", "'/'", "'=='", "'>'", "'>='", "'<'", "'<='", "'('", 
			"'-'", "'*'", "'!='", "'?'", "'+'", "')'", "';'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"FALSE", "SKIP_IF_NO_SOURCE", "BOOLEAN", "INTEGER", "KEYWORD", "TEXT", 
			"JSON", "BINARY", "GEO_POINT", "GEO_SHAPE", "UUID", "DECIMAL", "COMMA", 
	...
	public final ValueContext value() throws RecognitionException {
		...
		try {
			...
			setState(263);
			_la = _input.LA(1);
			if ( !(((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 209L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final OperatorContext operator() throws RecognitionException {
		...
		try {
			...
			setState(283);
			_la = _input.LA(1);
			if ( !(((((_la - 58)) & ~0x3f) == 0 && ((1L << (_la - 58)) & 2435L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final ComparisonOperatorContext comparisonOperator() throws RecognitionException {
		...
		try {
			...
			setState(308);
			_la = _input.LA(1);
			if ( !(((((_la - 59)) & ~0x3f) == 0 && ((1L << (_la - 59)) & 287L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final TypeContext type() throws RecognitionException {
		...
		try {
			...
			setState(317);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 143974450589619200L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
