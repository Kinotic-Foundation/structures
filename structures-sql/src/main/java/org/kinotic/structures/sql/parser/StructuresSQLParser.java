...
public class StructuresSQLParser extends Parser {
	...
	public static final int
		...
		BOOLEAN=43, INTEGER=44, KEYWORD=45, TEXT=46, JSON=47, BINARY=48, GEO_POINT=49, 
		GEO_SHAPE=50, UUID=51, DECIMAL=52, COMMA=53, DIVIDE=54, EQUALS=55, GREATER_THAN=56, 
		GREATER_THAN_EQUALS=57, LESS_THAN=58, LESS_THAN_EQUALS=59, LPAREN=60, 
		MINUS=61, MULTIPLY=62, NOT_EQUALS=63, PARAMETER=64, PLUS=65, RPAREN=66, 
		SEMICOLON=67, BOOLEAN_LITERAL=68, ID=69, INTEGER_LITERAL=70, STRING=71, 
		COMMENT=72, WS=73;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'INTEGER'", "'KEYWORD'", "'TEXT'", "'JSON'", "'BINARY'", "'GEO_POINT'", 
			"'GEO_SHAPE'", "'UUID'", "'DECIMAL'", "','", "'/'", "'=='", "'>'", "'>='", 
			"'<'", "'<='", "'('", "'-'", "'*'", "'!='", "'?'", "'+'", "')'", "';'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"INTEGER", "KEYWORD", "TEXT", "JSON", "BINARY", "GEO_POINT", "GEO_SHAPE", 
			"UUID", "DECIMAL", "COMMA", "DIVIDE", "EQUALS", "GREATER_THAN", "GREATER_THAN_EQUALS", 
	...
	public final ValueContext value() throws RecognitionException {
		...
		try {
			...
			setState(257);
			_la = _input.LA(1);
			if ( !(((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 209L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final OperatorContext operator() throws RecognitionException {
		...
		try {
			...
			setState(277);
			_la = _input.LA(1);
			if ( !(((((_la - 54)) & ~0x3f) == 0 && ((1L << (_la - 54)) & 2435L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final ComparisonOperatorContext comparisonOperator() throws RecognitionException {
		...
		try {
			...
			setState(302);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & -8106479329266892800L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final TypeContext type() throws RecognitionException {
		...
		try {
			...
			setState(311);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 8998403163837440L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
