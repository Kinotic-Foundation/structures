...
public class StructuresSQLParser extends Parser {
	...
	public static final int
		...
		WAIT=43, TRUE=44, FALSE=45, BOOLEAN=46, INTEGER=47, KEYWORD=48, TEXT=49, 
		JSON=50, BINARY=51, GEO_POINT=52, GEO_SHAPE=53, UUID=54, DECIMAL=55, COMMA=56, 
		DIVIDE=57, EQUALS=58, GREATER_THAN=59, GREATER_THAN_EQUALS=60, LESS_THAN=61, 
		LESS_THAN_EQUALS=62, LPAREN=63, MINUS=64, MULTIPLY=65, NOT_EQUALS=66, 
		PARAMETER=67, PLUS=68, RPAREN=69, SEMICOLON=70, BOOLEAN_LITERAL=71, ID=72, 
		INTEGER_LITERAL=73, STRING=74, COMMENT=75, WS=76;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'FALSE'", "'BOOLEAN'", "'INTEGER'", "'KEYWORD'", "'TEXT'", "'JSON'", 
			"'BINARY'", "'GEO_POINT'", "'GEO_SHAPE'", "'UUID'", "'DECIMAL'", "','", 
			"'/'", "'=='", "'>'", "'>='", "'<'", "'<='", "'('", "'-'", "'*'", "'!='", 
			"'?'", "'+'", "')'", "';'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"TEMPLATE", "UPDATE", "USING", "VALUES", "WHERE", "WITH", "WAIT", "TRUE", 
			"FALSE", "BOOLEAN", "INTEGER", "KEYWORD", "TEXT", "JSON", "BINARY", "GEO_POINT", 
			"GEO_SHAPE", "UUID", "DECIMAL", "COMMA", "DIVIDE", "EQUALS", "GREATER_THAN", 
	...
	public final MigrationsContext migrations() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 275952175624L) != 0) || _la==COMMENT) {
				{
				{
				setState(52);
				statement();
	...
	public final ValueContext value() throws RecognitionException {
		...
		try {
			...
			setState(260);
			_la = _input.LA(1);
			if ( !(((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & 209L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final OperatorContext operator() throws RecognitionException {
		...
		try {
			...
			setState(280);
			_la = _input.LA(1);
			if ( !(((((_la - 57)) & ~0x3f) == 0 && ((1L << (_la - 57)) & 2435L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final ComparisonOperatorContext comparisonOperator() throws RecognitionException {
		...
		try {
			...
			setState(305);
			_la = _input.LA(1);
			if ( !(((((_la - 58)) & ~0x3f) == 0 && ((1L << (_la - 58)) & 287L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final TypeContext type() throws RecognitionException {
		...
		try {
			...
			setState(314);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 71987225295868928L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
